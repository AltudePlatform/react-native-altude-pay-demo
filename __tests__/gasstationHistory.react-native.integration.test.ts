...
describe('installed Gas Station react-native history integration', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  it('loads mixed legacy, v0, and v1 entries through the shipped react-native adapter', async () => {
    ...
    const {fetchAccountHistory} = require('../src/services/gasstationAdapter');
